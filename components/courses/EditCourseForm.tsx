...
import { usePathname, useRouter } from "next/navigation"; // These hooks require the client component context
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <FormField control={form.control} name="title" render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Input placeholder="Ex: Web Development for Beginners" {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )} />
          ...
          <FormField control={form.control} name="subtitle" render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Input placeholder="Ex: Full-stack Development Course" {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )} />
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <RichEditor value={field.value || ""} onChange={field.onChange} placeholder="What is this course about?" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormControl><ComboBox options={categories} {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormControl><ComboBox options={levels} {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
